...
public class LocalDateUtil {
     ...
     * @return 目标时间字符串
     */
    public String minusMonth(String date, String originPatten, String destPatten, Integer minus) {
        DateTimeFormatter originFormat = DateTimeFormatter.ofPattern(originPatten);
        DateTimeFormatter destFormat = DateTimeFormatter.ofPattern(destPatten);
        LocalDate localDate = LocalDate.parse(date, originFormat);
        LocalDate destDate = localDate.minusMonths(minus);
